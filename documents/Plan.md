...
2. Месяц: номер текущего месяца, например 06
3. Год: последние две цифры текущего года, например 25
4. Владелец: фамилия и имя, например Ivanov Ivan
5. CVC/CVV: три цифры, например 599
...
3. Ввести месяц 06
4. Ввести последние две цифры года 25
5. Ввести имя Ivanov Ivan
6. Ввести CVC код 599
7. Нажать Продолжить
...
1. В поле Номер карты ввести цифру 7
...
1. Ввести CVC код одну цифру, например 7
2. Заполнить остальные поля валидными данными
3. Нажать Продолжить
* Ожидаемый результат: уведомление «Неверный формат»
